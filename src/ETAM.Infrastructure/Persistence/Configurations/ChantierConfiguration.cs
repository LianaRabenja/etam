...
public class ChantierConfiguration : IEntityTypeConfiguration<Chantier>
{
    public void Configure(EntityTypeBuilder<Chantier> b)
    {
        ...
        b.Property(x => x.MontantMarche).HasColumnType("numeric(18,2)").HasDefaultValue(0);
        b.Property(x => x.Benefice).HasColumnType("numeric(18,2)").HasDefaultValue(0);
